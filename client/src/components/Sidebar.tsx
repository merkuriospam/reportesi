...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, onLogout }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-72 bg-white shadow-2xl z-[10000] flex flex-col overflow-hidden transform transition-transform duration-300 ease-in-out ${
