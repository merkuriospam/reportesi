    ...
    <div className="max-w-md mx-auto mt-16 sm:mt-24 px-4">
      <div className="bg-white rounded-[2rem] shadow-2xl shadow-blue-100 p-8 border border-gray-50 relative overflow-hidden">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 font-medium mt-1">Súmate como Voluntario</p>
        </div>
        ...
        {success ? (
          <div className="text-center py-10">
            ...
            <p className="text-green-600 font-bold text-lg">¡Registro exitoso!</p>
            <p className="text-gray-500 text-sm mt-1">Redirigiendo al login...</p>
          </div>
        ) : (
